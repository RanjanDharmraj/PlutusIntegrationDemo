...
public class Request {
    ...
    public Request(long transactionType, String billingRefNo, String paymentAmount, String bankCode, String cardNumber, String expiry, String invoiceNo, boolean isSwipe, String field0, String field1, String field2, String field3, int batchNo, int roc, long transactionLogId, long rewardAmount, String customerMobileNumber, String customerEmailId, String merchantMobileNumber, String merchantEmailId, boolean consentCustomerMobile, boolean consentCustomerEmailId, boolean consentMerchantMobile, boolean consentMerchantEmailId, long walletProgramId, String currencyId, List<Products> products, List<AdditionalInfo> additionalInfo) {
